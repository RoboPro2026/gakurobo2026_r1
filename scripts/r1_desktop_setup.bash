...
chmod +x "$REPO_DIR/desktop/r1_record.desktop"
...
ln -sf "$REPO_DIR/desktop/r1_record.desktop" "$DESKTOP_DIR/r1_record.desktop"
...
gio set "$DESKTOP_DIR/r1_record.desktop" metadata::trusted true
