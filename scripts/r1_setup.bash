...
ARUCO_RED_DEV="/dev/serial/by-path/pci-0000:00:14.0-usb-0:1.1.2:1.0-port0"
ARUCO_BLUE_DEV="/dev/serial/by-path/pci-0000:00:14.0-usb-0:1.1.3:1.0-port0"
ARUCO_R2_LIFT_DEV="/dev/serial/by-path/pci-0000:00:14.0-usb-0:1.1.1:1.0"
...
ARUCO_RED_TTY="$(basename "$(readlink -f "$ARUCO_RED_DEV")")"
ARUCO_BLUE_TTY="$(basename "$(readlink -f "$ARUCO_BLUE_DEV")")"
ARUCO_R2_LIFT_TTY="$(basename "$(readlink -f "$ARUCO_R2_LIFT_DEV")")"
...
sudo chmod 666 "$ARUCO_RED_DEV"
sudo chmod 666 "$ARUCO_BLUE_DEV"
sudo chmod 666 "$ARUCO_R2_LIFT_DEV"
