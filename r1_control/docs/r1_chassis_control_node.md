...
| `inner_decel_start_pos.*` | `vector<double>` | `{100.0, 100.0}` | 内回り軌道で減速開始に使う矩形端点。 |
| `inner_decel_end_pos.*` | `vector<double>` | `{100.0, 100.0}` | 内回り軌道で減速終了に使う矩形端点。 |
| `outer_decel_start_pos.*` | `vector<double>` | `{100.0, 100.0}` | 外回り軌道で減速開始に使う矩形端点。 |
| `outer_decel_end_pos.*` | `vector<double>` | `{100.0, 100.0}` | 外回り軌道で減速終了に使う矩形端点。 |
